...
@ActionBar(title = "招商部统计")
@Layout(id = R.layout.view_controller_merchants_statistical)
public class MerchantsStatisticalViewController extends CrmBaseViewController {
...
//            loadData(userModel);
    ...
    private View.OnClickListener departmentStatisticsButtonListener = new View.OnClickListener(){
         ...
         public void onClick(View view) {
             ...
             i.putExtra(WebViewController.KEY_URL, ContextProvider.getBaseURL()+"/crm/app/customer/purchase_mydepartment?accessToken=" +
