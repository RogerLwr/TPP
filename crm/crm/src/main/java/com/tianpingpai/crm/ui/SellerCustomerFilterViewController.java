...
public class SellerCustomerFilterViewController extends BaseViewController {

    private CustomerFilterAdapter adapter = new CustomerFilterAdapter(CustomerModel.USER_TYPE_SELLER);
