...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
    ...
    protected void initData() {
        ...
        //计算每张图片应该显示的宽度
        perWidth = (((WindowManager) (CrmApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4))/3;
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (currentShowPosition == -1 && i==0){
                ...
                ((ImageView)view).setBackgroundResource(R.drawable.ic_1124_take_pic);
            ...
            if (getImageDirectoryModelStateFromMapById(i)){
                ...
                holder.iv_pick_or_not.setImageResource(R.drawable.btn_radio_on);
            }else{
                holder.v_gray_masking.setVisibility(View.GONE);
                holder.iv_pick_or_not.setImageResource(R.drawable.btn_radio_off);
            }
            //优化显示效果
            ...
            Log.e("tupiandizhi",path+"------");
            if (bitmap != null){
                Log.e("bitmap","buweikong");
                BitmapDrawable bd = new BitmapDrawable(getResources(), bitmap);
                holder.iv_content.setBackgroundDrawable(bd);
            }else{
                Log.e("bitmap","weikong");
//                holder.iv_content.setBackgroundResource(R.drawable.ic_product_9);
                holder.iv_content.setBackgroundResource(R.drawable.ic_151020_add_prod_img);
            }
            return view;
        }
    }
                    ...
                    for (String path : temp){
                        if (!picklist.contains(path)){
                            ...
                            if(v != null) {
                                ...
                                ((ImageView) ((ViewGroup) (v.getParent())).findViewById(R.id.iv_pick_or_not)).setImageResource(R.drawable.btn_radio_on);
                            }
                    ...
                    for (String path : picklist){
                        if (!temp.contains(path)){
                            ...
                            if(v != null) {
                                ...
                                ((ImageView) ((ViewGroup) (v.getParent())).findViewById(R.id.iv_pick_or_not)).setImageResource(R.drawable.btn_radio_off);
                            }
                            currentPicNums --;
...
//        void onSelectImage(ArrayList<String> list);
//    }
//    public void setOnSelectImageListener(OnSelectImageListener imageListener) {
//        this.onSelectImageListener = imageListener;
//    }
