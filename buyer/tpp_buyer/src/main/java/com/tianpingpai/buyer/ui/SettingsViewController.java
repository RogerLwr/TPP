...
import com.brother.tpp.activity.HelpActivity;
...
import com.tianpingpai.widget.SwitchButton;
...
public class SettingsViewController extends BaseViewController {
	...
	protected void onConfigureView(View rootView) {
		...
		SwitchButton pushToggleButton = (SwitchButton) rootView
		...
		if( !URLApi.IS_DEBUG && URLApi.REPLACE_ACCESSTOKEN){
	...
	private ResultListener<ModelResult<VersionModel>> updateListener = new ResultListener<ModelResult<VersionModel>>() {
		...
		public void onResult(HttpRequest<ModelResult<VersionModel>> request,
			...
			if (data.isSuccess()) {
				...
				ResultHandler.handleError(data, SettingsViewController.this);
			}
		}
	};
